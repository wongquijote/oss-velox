...
extern const std::unordered_map<FileFormat, std::function<FlushPolicyFactory::PolicyFactory(uint64_t, uint64_t)>> DefaultFactoryMap;
extern const std::unordered_map<FileFormat, std::function<FlushPolicyFactory::PolicyFactory(std::function<bool()>)>> LambdaFactoryMap;
